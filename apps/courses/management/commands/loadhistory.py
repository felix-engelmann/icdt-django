            ...
            for row in fcsv:
                ...
                for prof in handlers:
                    ...
                    if prof in manual_names:
                        ...
                        possibles = []
                        for poss in data:
                            if parts[1] == poss['Preferred Last Name'] and parts[0] == poss['Preferred First Name'][0]:
                        ...
                        poss = []
                        for paid in data:
                            if {paid['Preferred First Name'], paid['Preferred Last Name']} == partset:
                                poss.append(paid)
                    ...
                    p = Person.objects.get_or_create(first_name=first_name, last_name=last_name)[0]
                    profs.append(p)
